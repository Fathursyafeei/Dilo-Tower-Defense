...
public class Enemy : MonoBehaviour
{
    ...
    // Function ini terpanggil sekali menghidupkan game objek yang memiliki script ini.
    ...
    public void SetTargetPosition(Vector3 targetPosition)
    {
        ...
        {
            //  Jika Menghadap ke Atas
            if(distance.y > 0)
            {
                transform.rotation = Quaternion.Euler(new Vector3(0f, 0f, 90f));
            }
            // jika Menghadap bawah
            else
            {
                transform.rotation = Quaternion.Euler(new Vector3(0f, 0f, -90f));
            }
    ...
    // Function/method agar Enemy bisa hancur ketika health nya habis
